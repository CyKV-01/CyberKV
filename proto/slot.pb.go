...
func (x *SlotInfo) GetSlot() uint32 {
	if x != nil {
		return x.Slot
	}
	return 0
...
func (x *SlotInfo) GetNodes() map[string]*NodeInfo {
	if x != nil {
		return x.Nodes
	}
	return nil
...
var file_slot_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x1a, 0x0a, 0x6e, 0x6f, 0x64, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x99,
	0x01, 0x0a, 0x08, 0x53, 0x6c, 0x6f, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x12, 0x0a, 0x04, 0x73,
	0x6c, 0x6f, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x73, 0x6c, 0x6f, 0x74, 0x12,
	0x2f, 0x0a, 0x05, 0x6e, 0x6f, 0x64, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19,
	0x2e, 0x73, 0x6c, 0x6f, 0x74, 0x2e, 0x53, 0x6c, 0x6f, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x4e,
	...
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x43, 0x79, 0x4b, 0x56, 0x2d, 0x30, 0x31,
	0x2f, 0x43, 0x79, 0x62, 0x65, 0x72, 0x4b, 0x56, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06,
...
var file_slot_proto_goTypes = []interface{}{
	(*SlotInfo)(nil), // 0: slot.SlotInfo
	nil,              // 1: slot.SlotInfo.NodesEntry
	(*NodeInfo)(nil), // 2: node.NodeInfo
}
var file_slot_proto_depIdxs = []int32{
	1, // 0: slot.SlotInfo.nodes:type_name -> slot.SlotInfo.NodesEntry
	2, // 1: slot.SlotInfo.NodesEntry.value:type_name -> node.NodeInfo
